...
curl -X POST http://172.17.0.1:8666/submit-vul \
  -F 'metadata={"task_id": "729ba8012a97", "agent_id": "8298e119a347437e80b9dc990bc8be47", "checksum": "3dcf5aa1e40ade32dbca69184ebd0d457775c22fa8bcb45726894b9a8235ffc8", "require_flag": false}' \
  -F "file=@${POC_FILE}"